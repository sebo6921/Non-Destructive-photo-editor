...
public class EditActions {
   ...
   public EditActions(ResourceBundle bundle) {
       ...
       actions.add(new UndoAction(bundle.getString("Undo"), null, bundle.getString("UndoDesc"), Integer.valueOf(KeyEvent.VK_Z)));
       actions.add(new RedoAction(bundle.getString("Redo"), null, bundle.getString("RedoDesc"), Integer.valueOf(KeyEvent.VK_X)));
   }
   ...
   public JMenu createMenu() {
       JMenu editMenu = new JMenu(bundle.getString("EditMenu"));
