...
public class ColourActions {
    ...
    public ColourActions() {
        ...
        actions.add(
                new ConvertToGreyAction("Greyscale (G)", null, "Convert to greyscale", Integer.valueOf(KeyEvent.VK_G)));
        actions.add(new ImageInversionAction("Invert Image (I)", null, "Invert image colours",
                Integer.valueOf(KeyEvent.VK_I)));
        actions.add(new ColourChannelCyclingAction("Colour Channel Cycling (C)", null, "Cycle image colour channels",
