...
public class ColourActions {
   ...
   public ColourActions(ResourceBundle bundle) {
       ...
       actions.add(new ImageInversionAction(bundle.getString("InvertImage"), null, bundle.getString("InvertImageDesc"), Integer.valueOf(KeyEvent.VK_I)));
       actions.add(new ColourChannelCyclingAction(bundle.getString("ColourChannelCycling"), null, bundle.getString("ColourChannelCyclingDesc"), Integer.valueOf(KeyEvent.VK_C)));
