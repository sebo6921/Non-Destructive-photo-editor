...
public class Resize implements ImageOperation, java.io.Serializable{
    ...
    // Constructor that takes a size parameter and sets the size attribute accordingly
    Resize(int size){
        this.size = size;
    }

    // Default constructor that initializes the size attribute with a default value of 100
    Resize(){
        this(100);
    }
    ...
    public BufferedImage apply(BufferedImage input){
        ...
        // Draw the scaled instance of the input image onto the output image with smooth scaling
